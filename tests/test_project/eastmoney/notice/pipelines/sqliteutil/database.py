...
class Database(object):
    ...
    def get_table_indices(self, table_name, exclude_autoindex=False):
    ...
    def get_all_indices(self, exclude_autoindex=False):
        cu = self.conn.cursor()
    ...
    def drop_all_indices(self, exclude_autoindex=False):
